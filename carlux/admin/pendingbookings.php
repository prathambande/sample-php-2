            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">Pending bookings</a></li>
                    </ul>
                </div>
            </div>
            ...
            <table id="vehicle-table" class="table" >
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="pendingbookings.php?approved=<?php echo $row['id']; ?>" class="update-btn"><span class="material-symbols-outlined">check_circle</span></a> 
                    </td>
                  </tr>
                  <?php
                  }    
...
if(isset($_GET['approved'])){
   ...
   mysqli_select_db($con, "carlux");
   $q1 = "UPDATE `bookings` set status='approved' WHERE id = $approved_id ";
   $result = mysqli_query($con, $q1);
   if($result){
    echo '<script type="text/javascript">';
    echo 'window.location.href="pendingbookings.php";';
    echo '</script>';
   }
}
?>