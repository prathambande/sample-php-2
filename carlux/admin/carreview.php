    ...
    <div class="content">
        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">Reviews & Rating</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="group">
                ...
                <input id="search-input" placeholder="Search by car" type="search" class="input">
            </div>
            ...
            <table id="vehicle-table" class="table" >
                ...
                <tbody>
                <a href='addfuelcar.php'></a><br><br>
                <?php
                if(isset($_GET['review'])){
                    $carname = $_GET['review'];
                mysqli_select_db($con, "carlux");
                $q1 = "SELECT * FROM `reviews` where carname='$carname'";
