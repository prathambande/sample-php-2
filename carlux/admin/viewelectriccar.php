    ...
    <div class="content">
        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">electric cars</a></li>
                    </ul>
                </div>
            </div>
            ...
            <table id="vehicle-table" class="table" >
                ...
                <tbody>
                <a href='addelectriccar.php' class="addbtn">Add New</a><br><br>
                <?php
                ...
                ?>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="updateelectriccar.php?edit=<?php echo $row['id']; ?>" class="update-btn"><span class="material-symbols-outlined">edit</span></a>
                        <a href="viewelectriccar.php?delete=<?php echo $row['id']; ?>"  onclick="return confirm('are your sure you want to delete this?');" class="delete-btn" ><ico class="material-symbols-outlined">delete</ico></a>
...
if(isset($_GET['delete'])){
    ...
    mysqli_select_db($con, "carlux");
    $q1 = "DELETE FROM `electric_car` WHERE id = $delete_id ";
    $result = mysqli_query($con, $q1);
    if($result){
