        ...
        <div class="login-box">
          ...
          <div class="group">
            <span class="material-symbols-outlined">alternate_email</span>
              <input class="input" type="text" name="email" placeholder="Enter Your E-mail" required>
            </div>
            <br>
            <input type="submit" value="Send otp" name="forgot" class="login__button">                    
          </form>
        </div>
  </div>
</body>
          ...
          else
          {
            ...
            if($data)
            {
              ...
              if(mail($email, $subject, $message, $sender)){
                  ...
                  echo 'window.location.href="reset-code.php";';
                  echo '</script>';
                  exit();
              }else{
                  ?>
