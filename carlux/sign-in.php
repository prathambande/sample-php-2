            ...
            elseif(mysqli_num_rows($r)===0)
            {
              ...
              const Toast = Swal.mixin({
                ...
                Toast.fire({
                  icon: "warning",
                  title:"Invalid !",
                  text: 'You Enter Incorrect Email Address !',
                });
                </script>
              <?php
            }
            else
            {
              ...
              $data= mysqli_query($con, $q1);
                  ...
                  if(mysqli_num_rows($data)>0)
                  {
                    ...
                    mysqli_select_db($con, "carlux");
                    $q1="UPDATE user_detail SET activation = 'active', last_login = CURRENT_TIMESTAMP , last_logout='' WHERE email = '$user'";
                    $data= mysqli_query($con, $q1);
                  ...
                  ?>
                      ...
                      const Toast = Swal.mixin({
                        ...
                        Toast.fire({
                          icon: "warning",
                          title:"Invalid !",
                          text: 'You Enter Incorrect Password !',
                        });
                        </script>
                  <?php
                }
